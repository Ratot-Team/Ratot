...
const sendPaginatedEmbed = async (channel, embeds, userId, timeout, currentYear) => {
    let page = 0;
    ...
    embeds[page].setFooter({
        text:
            "Copyright © 2020-" + currentYear + " by Captain Ratax" + " | Page 1 of " + embeds.length,
        iconURL:
            "https://cdn.discordapp.com/avatars/759404636888498186/7767a8b3aae66dc5198ca89f7fc16173.png?size=512",
    });

    const message = await channel.send({ embeds: [embeds[page]], components: [row] });
    ...
    collector.on('collect', async (interaction) => {
        ...
        embeds[page].setFooter({
            text:
                "Copyright © 2020-" + currentYear + " by Captain Ratax" + " | Page " + (page+1) + " of " + embeds.length,
            iconURL:
                "https://cdn.discordapp.com/avatars/759404636888498186/7767a8b3aae66dc5198ca89f7fc16173.png?size=512",
        });
